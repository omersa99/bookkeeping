...
import { ChartOfAccountUpdateInput } from "./ChartOfAccountUpdateInput";
...
export class ChartOfAccountControllerBase {
  constructor(
  ...
  @common.Post()
  @swagger.ApiCreatedResponse({ type: ChartOfAccount })
  ...
  @common.Get()
  @swagger.ApiOkResponse({ type: [ChartOfAccount] })
  ...
  async findMany(@common.Req() request: Request): Promise<ChartOfAccount[]> {
    const args = plainToClass(ChartOfAccountFindManyArgs, request.query);
  ...
  async update(
    @common.Param() params: ChartOfAccountWhereUniqueInput,
    @common.Body() data: ChartOfAccountUpdateInput
  ): Promise<ChartOfAccount | null> {
    try {
  ...
  async findManyAccountsSet(
    @common.Req() request: Request,
    @common.Param() params: ChartOfAccountWhereUniqueInput
  ): Promise<Account[]> {
    const query = plainToClass(AccountFindManyArgs, request.query);
    const results = await this.service.findAccountsSet(params.id, {
      ...query,
      select: {
        balanceType: true,
  ...
  @common.Post("/:id/accountsSet")
  @nestAccessControl.UseRoles({
    resource: "ChartOfAccount",
    action: "update",
    possession: "any",
  })
  async connectAccountsSet(
    @common.Param() params: ChartOfAccountWhereUniqueInput,
  ...
  @common.Patch("/:id/accountsSet")
  @nestAccessControl.UseRoles({
    resource: "ChartOfAccount",
    action: "update",
    possession: "any",
  })
  async updateAccountsSet(
    @common.Param() params: ChartOfAccountWhereUniqueInput,
    @common.Body() body: AccountWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/accountsSet")
  @nestAccessControl.UseRoles({
    resource: "ChartOfAccount",
    action: "update",
    possession: "any",
  })
  async disconnectAccountsSet(
    @common.Param() params: ChartOfAccountWhereUniqueInput,
    @common.Body() body: AccountWhereUniqueInput[]
  ): Promise<void> {
    const data = {
