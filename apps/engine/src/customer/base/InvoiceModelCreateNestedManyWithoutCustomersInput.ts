...
@InputType()
class InvoiceModelCreateNestedManyWithoutCustomersInput {
...
export { InvoiceModelCreateNestedManyWithoutCustomersInput as InvoiceModelCreateNestedManyWithoutCustomersInput };
