...
@InputType()
class ItemTransactionUpdateManyWithoutEntitiesInput {
...
export { ItemTransactionUpdateManyWithoutEntitiesInput as ItemTransactionUpdateManyWithoutEntitiesInput };
