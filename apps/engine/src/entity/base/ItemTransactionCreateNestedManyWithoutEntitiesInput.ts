...
@InputType()
class ItemTransactionCreateNestedManyWithoutEntitiesInput {
...
export { ItemTransactionCreateNestedManyWithoutEntitiesInput as ItemTransactionCreateNestedManyWithoutEntitiesInput };
