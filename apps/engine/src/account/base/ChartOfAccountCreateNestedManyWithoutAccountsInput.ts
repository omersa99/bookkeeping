...
@InputType()
class ChartOfAccountCreateNestedManyWithoutAccountsInput {
...
export { ChartOfAccountCreateNestedManyWithoutAccountsInput as ChartOfAccountCreateNestedManyWithoutAccountsInput };
